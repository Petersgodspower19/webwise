...
function HomeProjects() {
  return (
    <div>
      <h1 className='text-center font-bold text-[35px] md:text-[40px] text-black mt-5 mb-6'  data-aos="fade-up">
        See Our Projects
      </h1>
      <p className='text-center text-black w-[80%] m-auto' data-aos="fade-up">
